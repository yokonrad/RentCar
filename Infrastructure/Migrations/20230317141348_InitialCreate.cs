...
namespace Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Reservations_Locations_LocationFromId",
                        column: x => x.LocationFromId,
                        principalTable: "Locations",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Reservations_Locations_LocationToId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_LocationFromId",
                table: "Reservations",
                column: "LocationFromId");

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_LocationToId",
                table: "Reservations",
                column: "LocationToId");
        }
